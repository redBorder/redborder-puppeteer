...
echo -e "/* This file and package-lock.json are being generated by the puppeteer-rpm repository, sorry in advance */\n$(cat package.json)" > %{buildroot}/var/www/rb-rails/package.json
